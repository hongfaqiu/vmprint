  ...
  overlay(page, ctx) {
    ...
    if (page.index === 0) {
      ...
      // Row 1: top/bottom lane rules.
      {
        ...
        ctx.moveTo(iconX, y + 1).lineTo(iconX + 22, y + 1).stroke();
        ctx.moveTo(iconX, y + 7).lineTo(iconX + 22, y + 7).stroke();
        ctx.undash();
        ctx.restore();
      ...
      // Row 3: order connector.
      {
        ...
        ctx.moveTo(iconX, y + 4).lineTo(iconX + 22, y + 4).stroke();
        ctx.undash();
        ctx.restore();
    ...
    imageBoxes.forEach((box) => {
      ...
      ctx.moveTo(leftEdge, box.y + box.h).lineTo(rightEdge, box.y + box.h).stroke();
      ctx.undash();
      ctx.restore();
      ...
      if (previousImage) {
        if (previousImage.pageIndex === page.index) {
          ...
          ctx.moveTo(previousImage.centerX, previousImage.centerY).lineTo(railX, previousImage.centerY).stroke();
